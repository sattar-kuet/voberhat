...
if ( !function_exists ('greenmart_tbay_custom_styles') ) {
	function greenmart_tbay_custom_styles() {
		...
		?>
			...
			/**********************************button hover*****************************/
			<?php if ( greenmart_tbay_get_config('button_hover_color') != "" ) : ?>
				...
				.archive-shop div.product .information .single_add_to_cart_button:hover,.archive-shop div.product .information .single_add_to_cart_button:active {
					background:<?php echo esc_html( greenmart_tbay_get_config('button_hover_color') ) ?> !important;
				}
			<?php endif; ?>
			...
			/* Custom CSS */
			<?php if ( greenmart_tbay_get_config('custom_css') != "" ) : ?>
				<?php echo greenmart_tbay_get_config('custom_css') ?>
			<?php endif; ?>
