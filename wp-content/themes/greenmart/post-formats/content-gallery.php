	        	...
	        	<div class="entry-header">
					...
					if ( has_post_thumbnail() ) {
						...
						<figure class="entry-thumb <?php echo  (!has_post_thumbnail() ? 'no-thumb' : ''); ?>">
							...
							<span class="comments-link"><i class="icofont icofont-speech-comments"></i> <?php comments_popup_link( esc_html__( '0', 'greenmart' ), esc_html__( '1', 'greenmart' ), esc_html__( '%', 'greenmart' ) ); ?></span>
