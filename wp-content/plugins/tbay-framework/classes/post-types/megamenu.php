...
class Tbay_PostType_Megamenu {
	...
	?>
		<p class="field-icon-font description description-wide">   
			...
			<br>
			<span><?php printf( __( 'This support display icon from <a href="%s" target="_blank">FontAwsome</a>, <a href="%s" target="_blank">Material Design Iconic</a> and <a href="%s" target="_blank">Simple Line</a>', 'tbay-framework' ), 'http://fontawesome.io/icons/','http://zavoloklom.github.io/material-design-iconic-font/icons.html','http://simplelineicons.com/');?></span>
		</p>
